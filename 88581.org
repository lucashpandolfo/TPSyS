...
#+begin_src octave :exports results :results file
  ...
  argumento =  sum(phase(fftshift(espectros)),1)/rows(datos_no_chirp);
...
#+begin_src octave :exports results :results file
  ...
  legend(['Frecuencia central: ' num2str(chirps{1}{2})],
         ['Frecuencia central: ' num2str(chirps{2}{2})],
         ['Frecuencia central: ' num2str(chirps{3}{2})]);

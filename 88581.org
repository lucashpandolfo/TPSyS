...
#+begin_src octave :exports results :results file
  ...
  espectroReal = fft(real(chirp_nm));
  ...
  subplot(413);
  desvio = Fs/2;
  plot(Fs/t(end) * t+200e6-desvio,20*log10(abs(espectroA)), "linewidth", 3);
  axis([200e6-desvio 200e6+desvio 0 30])
  cambiarEjeX("%0.0fMhz", 1/1e6);
  cambiarEjeY("%ddB", 1);
  grid();
  ...
  subplot(414);
  desvio = Fs/2;
  plot(Fs/t(end) * t+200e6-desvio,20*log10(abs(espectroReal)), "linewidth", 3);
  axis([200e6-desvio 200e6+desvio 0 30])
  cambiarEjeX("%0.0fMhz", 1/1e6);
  cambiarEjeY("%ddB", 1);
  grid();

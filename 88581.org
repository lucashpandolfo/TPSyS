...
#+begin_src matlab :exports results :results file
  ...
  tic
  ans = print('-djpeg', 'img/compresion-en-rango.jpg');
  toc
...
#+begin_src matlab :exports results :results file
  ...
  imagesc(comprimida);
  ans = guardarImagen('img/azimuth-1.pdf');
  
#+end_src
#+results:
   [[file:img/azimuth-1.pdf]]
...
#+begin_src matlab :exports results :results file
  ...
  ans = guardarImagen('img/azimuth-kaiser.pdf');
#+end_src
#+results:
   [[file:img/azimuth-kaiser.pdf]]
...
#+begin_src matlab :exports results :results file
  ...
  ans = guardarImagen('img/azimuth-promediada.pdf');
#+end_src

#+results:
   [[file:img/azimuth-promediada.pdf]]

...
#+BEGIN_LATEX
  \begin{figure}[H]
    ...
    \begin{pspicture}[showgrid=false](-1,-5)(11,4)
      ...
      \nclist{ncline}[naput]{prod2,lp1 $D$,ad1 $I(t)$,salida2 $I(n)$}
      \nclist{ncline}[naput]{prod3,lp2 $D$,ad2 $Q(t)$,salida3 $Q(n)$}
...
#+begin_src octave :exports results :results file
  ...
  text(-130,22, ['fc1: ',num2str(fc1/10-25), 'Mhz'], 'fontsize', 20);  
  text(-130,18, ['fc2: ',num2str(fc2/10-25), 'Mhz'], 'fontsize', 20);  
  text(-130,14, ['Ancho de banda: ',num2str(bw), 'Mhz'], 'fontsize', 20);
